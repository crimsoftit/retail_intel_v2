...
class TTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle()
        .copyWith(fontSize: SizeConfig.fontSizeMd, color: AppColors.black),
    hintStyle: const TextStyle()
        .copyWith(fontSize: SizeConfig.fontSizeSm, color: AppColors.black),
    errorStyle: const TextStyle().copyWith(fontStyle: FontStyle.normal),
    floatingLabelStyle:
        const TextStyle().copyWith(color: AppColors.black.withOpacity(0.8)),
    border: const OutlineInputBorder().copyWith(
      borderRadius: BorderRadius.circular(SizeConfig.inputFieldRadius),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    // constraints: const BoxConstraints.expand(height: TSizes.inputFieldHeight),
    labelStyle: const TextStyle()
        .copyWith(fontSize: SizeConfig.fontSizeMd, color: AppColors.white),
    hintStyle: const TextStyle()
        .copyWith(fontSize: SizeConfig.fontSizeSm, color: AppColors.white),
    floatingLabelStyle:
